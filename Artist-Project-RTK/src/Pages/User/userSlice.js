...
const usersSlice = createSlice({
  ...
  extraReducers: (builder) => {             //It handle the API Request statuses(pending, fulfilled, rejected) and update the state acordingly
    builder
    .addMatcher(
...
} = usersAdapter.getSelectors((state) => state.users);    //create a selector to select the users from state
